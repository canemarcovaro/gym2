...
public class ControladorMenu implements ActionListener {
    ...
    public ControladorMenu(ControladorClientes cc,ControladorReportes cr, Menu m, ControladorTarifas ct,ControladorPagos cp) {
        this.cc = cc;
        this.cp = cp;
        this.m = m;
        this.cr = cr;
        ...
        this.m.btnReportes.addActionListener(this);
    }
